...
import { Bold, Heading2, Italic, List, ListOrdered, Loader2, Newspaper, Pencil, Plus, Quote, Redo2, RefreshCw, RemoveFormatting, Search, Trash2, Underline, Undo2, X } from "lucide-react";
...
function sanitizeBlogHtml(value: string) {
  ...
  const allowedTags = new Set(["P", "BR", "DIV", "H2", "STRONG", "B", "EM", "I", "U", "UL", "OL", "LI", "BLOCKQUOTE"]);
