...
export default function View360Page() {
  ...
  return (
    <section ref={rootRef} className="relative h-[calc(100vh-80px)] min-h-[620px] overflow-hidden bg-black text-white">
      ...
      <div className="absolute inset-x-0 bottom-0 p-4 sm:p-6 lg:pr-[390px]">
      ...
      <aside className="absolute bottom-5 right-5 top-20 hidden w-[340px] flex-col overflow-hidden rounded-lg border border-white/15 bg-black/45 p-4 backdrop-blur-xl lg:flex">
