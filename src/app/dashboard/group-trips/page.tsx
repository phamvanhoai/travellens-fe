...
import { CalendarDays, Mail, MapPinned, Plus, Search, Users } from "lucide-react";
...
export default function GroupTripsPage() {
  ...
  return <div className="rounded-lg border border-slate-200 bg-white p-6 shadow-sm">
    ...
    <div className="mt-6 flex gap-2 border-b border-slate-200"><Link href="/dashboard/group-trips" className="border-b-2 border-brand-600 px-4 py-3 text-sm font-bold text-brand-700"><MapPinned className="mr-2 inline size-4" />My Trips</Link><Link href="/dashboard/group-trips/invitations" className="px-4 py-3 text-sm font-semibold text-slate-500 hover:text-brand-600"><Mail className="mr-2 inline size-4" />Invitations</Link></div>
